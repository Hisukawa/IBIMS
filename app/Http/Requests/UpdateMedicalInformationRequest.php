...
class UpdateMedicalInformationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'medications.*.medication' => ['nullable', 'string', 'max:100'],
            ...
            'medical_conditions.*.condition' => ['nullable', 'string', 'max:100'],
            'medical_conditions.*.status' => ['nullable', Rule::in(['active', 'resolved', 'chronic'])],
