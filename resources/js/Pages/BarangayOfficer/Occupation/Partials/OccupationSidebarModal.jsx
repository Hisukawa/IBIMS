                            ...
                            <div className="grid grid-cols-1 gap-6 p-6 lg:grid-cols-3">
                                ...
                                <div className="flex flex-col items-center rounded-2xl border border-slate-200 bg-slate-50 p-5 text-center">
                                    <div className="relative">
                                        ...
                                        />
                                        <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 rounded-full bg-emerald-600 px-2.5 py-1 text-[10px] font-medium text-white shadow">
                                            Resident
                                        </div>
                                    </div>
                                ...
                                <div className="space-y-5 lg:col-span-2">
                                    ...
                                    <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 sm:max-w-xs">
                                        <SelectField
